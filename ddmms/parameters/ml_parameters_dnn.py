...
class HyperParametersDNN:
  ...
  """
    ...
    def update_model_info(self, index0, history):
        ...
        self.all_hyperparameter_info['model_loss_summary'][index0]['loss'].append(train_loss)
        self.all_hyperparameter_info['model_loss_summary'][index0]['val_loss'].append(val_loss_min)
    ...
    def generate_all_DNNs(self):
        ...
        # [2, 512, 2]
        neuron_num = ml_misc.getlist_int(self.config['HYPERPARAMETERS']['NodesList'])
        # print(neuron_num)
    ...
    def do_the_sampling(self):
        ...
        for i0 in range(0, len(index_list) - 1):
            ...
            search_layer_number = list(
                range(self.all_hyperparameter_info["search_hl_range"][0],
                      self.all_hyperparameter_info["search_hl_range"][1]))
    ...
    def get_next_model(self):
        ...
        self.para_str = 'V' + str(this_DNN[2]) + '-' + 'model-' + 'H' + str(len(ml_misc.getlist_int(self.config['MODEL']['NodesList']))) \
