...
config['TEST']['DataFile'] = '../../data/cnn-m-dns-base-free-energy/single-dns/13/*.vtk'
dataset, labels, derivative, train_stats = ml_preprocess.load_all_data(config, args)
label_nn = model.predict(dataset, verbose=0, batch_size=batch_size)
all_data['label_dns'].append(labels/label_scale)
all_data['label_nn'].append(np.squeeze(label_nn)/label_scale)

config['TEST']['DataFile'] = '../../data/cnn-m-dns-base-free-energy/single-dns/2/*.vtk'
dataset, labels, derivative, train_stats = ml_preprocess.load_all_data(config, args)
label_nn = model.predict(dataset, verbose=0, batch_size=batch_size)
all_data['label_dns'].append(labels/label_scale)
all_data['label_nn'].append(np.squeeze(label_nn)/label_scale)

config['TEST']['DataFile'] = '../../data/cnn-m-dns-base-free-energy/single-dns/32/*.vtk'
dataset, labels, derivative, train_stats = ml_preprocess.load_all_data(config, args)
label_nn = model.predict(dataset, verbose=0, batch_size=batch_size)
all_data['label_dns'].append(labels/label_scale)
all_data['label_nn'].append(np.squeeze(label_nn)/label_scale)

config['TEST']['DataFile'] = '../../data/cnn-m-dns-base-free-energy/single-dns/46/*.vtk'
dataset, labels, derivative, train_stats = ml_preprocess.load_all_data(config, args)
label_nn = model.predict(dataset, verbose=0, batch_size=batch_size)
all_data['label_dns'].append(labels/label_scale)
all_data['label_nn'].append(np.squeeze(label_nn)/label_scale)

config['TEST']['DataFile'] = '../../data/cnn-m-dns-base-free-energy/single-dns/8/*.vtk'
dataset, labels, derivative, train_stats = ml_preprocess.load_all_data(config, args)
label_nn = model.predict(dataset, verbose=0, batch_size=batch_size)
all_data['label_dns'].append(labels/label_scale)
all_data['label_nn'].append(np.squeeze(label_nn)/label_scale)
