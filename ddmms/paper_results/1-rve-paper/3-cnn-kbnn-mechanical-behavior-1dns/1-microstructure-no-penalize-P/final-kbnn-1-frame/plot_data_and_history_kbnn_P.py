...
if __name__ == '__main__':
    ...
    plt.legend()
    # plt.axis('equal')
    plt.savefig('kbnn-cnn-1-frame-learning.pdf', bbox_inches='tight', format='pdf')
    plt.show()
    ...
    plt.savefig('kbnn-cnn-1-frame-test.pdf', bbox_inches='tight', format='pdf')
    plt.show()
    ...
    def plot_P_one_field(plt, P_true, P_pred, ind0):
        ...
        plt.xlim([amin, amax])
        plt.ylim([amin, amax])
        plt.savefig('kbnn-cnn-1-frame-'+pre_fix+'.pdf', bbox_inches='tight', format='pdf')
        plt.show()
